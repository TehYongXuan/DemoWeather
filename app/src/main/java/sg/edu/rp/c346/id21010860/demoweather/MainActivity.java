package sg.edu.rp.c346.id21010860.demoweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        ArrayList<Weather> alWeather = new ArrayList<Weather>();    //arraylist to store the data

        client.get("https://api.data.gov.sg/v1/environment/2-hour-weather-forecast", new JsonHttpResponseHandler() {    //object of asynchttpclient
